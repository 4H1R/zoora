...
export const Route = createFileRoute("/_auth/org/classes/classsessions/$classSessionId")({
  ...
  return (
    ...
    >
      ...
      <div className="mt-7 flex flex-wrap items-center gap-3">
        ...
        <Button variant="outline" render={<Link to="/org/classes/$classId" params={{ classId }} />}>
...
function RouteComponent() {
  ...
  return (
    <div className="relative isolate flex flex-col gap-8 pb-16">
      ...
      <Breadcrumb classId={classId ?? ""} classLabel={cls?.name} />
