...
export const Route = createFileRoute("/_auth/org/$orgId/offlines/$offlineId")({
...
function RouteComponent() {
  ...
  const { orgId, offlineId } = Route.useParams()
    ...
    <div className="flex flex-col gap-10 pb-16">
      <div className="pt-6">
        <Link
          ...
          params={{ orgId, classSessionId: room.class_session_id ?? "" }}
